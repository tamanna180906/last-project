...
import { decreaseQun, increaseQun, removeCart } from '../components/slice/productSlice'
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700  md:p-6">
                                        <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                            ...
                                            <div className="flex items-center justify-between md:order-3 md:justify-end">
                                                <div className="flex items-center">
                                                    <button
                                                        type="button"
                                                        id="decrement-button"
                                                        onClick={() => dispatch(decreaseQun(item))}
                                                    ...
                                                    <button
                                                        type="button"
                                                        id="increment-button"
                                                        onClick={() => dispatch(increaseQun(item))}
                                            ...
                                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                <a
                                                    href="#"
                                                    className="text-base font-medium text-gray-900 hover:underline dark:text-black"
                                                >
                                                    {item.title}
                                                </a>
