        ...
        <div className='py-[100px]'>
            <Container>
                ...
                <div className='w-[13%] pt-[10px] flex justify-between items-center'>
                    <h2 className='font-dm text-[16px] text-[#767676]'>$88.00</h2>
                    <h1 className='font-dm font-bold text-[20px] text-[#262626]'>$44.00</h1>
                </div>
                <div className='border-[#F0F0F0] w-[50%] border-b-2 py-5'></div>
                <div className='w-[20%] pt-[50px] flex justify-between items-center'>
                    <h2 className='font-dm font-bold text-[16px] text-[#262626] '>COLOR:</h2>
                    <div className='flex justify-between gap-2 items-center'>
                        <div className='h-[20px] w-[20px] bg-[#979797] rounded-full '></div>
                ...
                <div className='w-[20%] pt-[30px] flex justify-between items-center'>
                    ...
                    <select className='py-2 px-4 w-[130px] border-2 border-[#F0F0F0] rounded-1xl'>
                        <option className='text-[16px] text-[#767676] font-dm'>S</option>
                        <option className='text-[16px] text-[#767676] font-dm'>M</option>
                        <option className='text-[16px] text-[#767676] font-dm'>XL</option>
                        <option className='text-[16px] text-[#767676] font-dm'>XXL</option>
                    </select>
                </div>
                <div className='w-[20%] pt-[30px] flex justify-between items-center'>
